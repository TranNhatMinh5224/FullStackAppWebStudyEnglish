...
namespace CleanDemo.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250924124224_AddTableNamesAndMissingEntities")]
    partial class AddTableNamesAndMissingEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CleanDemo.Domain.Domain.StateUser", b =>
                {
                    ...
                    b.ToTable("StateUsers", (string)null);
            ...
            modelBuilder.Entity("CleanDemo.Domain.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedAt = new DateTime(2025, 9, 24, 12, 42, 24, 531, DateTimeKind.Utc).AddTicks(6956),
                            ...
                            Status = 0,
                            SureName = "Admin",
                            UpdatedAt = new DateTime(2025, 9, 24, 12, 42, 24, 531, DateTimeKind.Utc).AddTicks(6957)
                        });
                });
