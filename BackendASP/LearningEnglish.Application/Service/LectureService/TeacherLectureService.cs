...
{
    public class TeacherLectureService : ITeacherLectureService
    {
        ...
        private readonly ILogger<TeacherLectureService> _logger;
        ...
        public TeacherLectureService(
            ILectureRepository lectureRepository,
            IModuleRepository moduleRepository,
            ILessonRepository lessonRepository,
            ICourseRepository courseRepository,
            IMapper mapper,
            ILogger<TeacherLectureService> logger,
        ...
        // Teacher lấy lecture theo ID (read-only)
        ...
        // Teacher lấy danh sách lecture theo module (read-only)
        ...
        // Teacher lấy cây lecture (read-only)
