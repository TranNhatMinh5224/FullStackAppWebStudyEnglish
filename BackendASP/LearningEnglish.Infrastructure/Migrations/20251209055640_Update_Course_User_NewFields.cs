...
{
    /// <inheritdoc />
    public partial class Update_Course_User_NewFields : Migration
    {
        private static readonly string[] columns = new[] { "DateOfBirth", "IsMale", "NormalizedEmail", "PasswordHash", "Username" };
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: columns,
                values: new object[] { null, true, "", "$2a$11$GhCiugmI8OjqqXyERvoAn.1y5B4nr9p2xiEOZXlNESzHUnTZHmI12", "" });
