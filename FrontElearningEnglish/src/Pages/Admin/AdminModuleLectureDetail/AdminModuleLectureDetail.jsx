...
import { FaPlus, FaEdit, FaTrash, FaBook, FaVideo, FaHeadphones, FaFileAlt, FaGamepad } from "react-icons/fa";
...
export default function AdminModuleLectureDetail() {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [moduleId, isAuthenticated, isAdmin, navigate]);
  ...
  const fetchData = async () => {
    ...
    try {
      const [moduleRes, lecturesRes] = await Promise.all([
        ...
        lectureService.getAdminLecturesByModule(moduleId)
      ]);
