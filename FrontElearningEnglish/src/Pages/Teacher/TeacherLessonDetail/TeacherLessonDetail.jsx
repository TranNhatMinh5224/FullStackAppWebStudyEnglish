...
export default function TeacherLessonDetail() {
  ...
  const handleCreateModuleSuccess = (newModuleData) => {
    console.log("New module data:", newModuleData); // Debug log
    ...
    if (newModuleData && (newModuleData.imageUrl || newModuleData.ImageUrl)) {
      ...
      console.log("Normalized module with image:", normalizedModule); // Debug log
      ...
      console.log("No image URL in response, refreshing modules list");
      fetchModules();
    }
  };
