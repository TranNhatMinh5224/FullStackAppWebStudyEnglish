...
public class FlashCardMediaService : IFlashCardMediaService
{
    ...
    // FlashCard uses different buckets for audio and image
    private const string AudioBucket = "flashcard-audio";
    private const string ImageBucket = "flashcards";
    ...
    public string BuildImageUrl(string? imageKey)
    {
        ...
        return BuildPublicUrl.BuildURL(ImageBucket, imageKey);
    }
    ...
    public string BuildAudioUrl(string? audioKey)
    {
        ...
        return BuildPublicUrl.BuildURL(AudioBucket, audioKey);
    }
}
